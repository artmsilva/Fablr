...
| **Last Update** | `2025-11-29 04:12 EST` |
...
- `2025-11-29 04:12 EST` &mdash; **Font fix**: Updated `src/style.css` and `src/design-system/font-syntax.css` so the syntax font uses relative URLs (works when hosted at `/fable/`). Rebuilt via `npm run build` and ready for redeploy.
